...
This repo is the unofficial Fitbit MCP connector for local agent workflows.
...
- Never commit OAuth client secrets, access tokens, refresh tokens, personal Fitbit data, or local config.
